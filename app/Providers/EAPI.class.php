...
class EAPI
{
	...
	public function sendRequest($request, $parameters = array(), $isBulk = 0)
	{
	...
	protected function getSessionKey() 
	{
		...
		if(
			...
			//make request
			$result = $this->sendRequest("verifyUser", array("username" => $this->username, "password" => $this->password,"sessionLength"=>"86400"));
